...
// import { registerUser, resetUser } from "../auth/authSlice";
...
//   const { regUserState, regLoading, regError, regSuccess, regErrMsg } =
...
//       toast.info("Loading...");
//     } else if (regSuccess) {
//       toast.success(regUserState?.message, { autoClose: 3000 });
//       navigate("/");
//     } else if (regErrMsg) {
//       toast.error(regErrMsg, { autoClose: 3000 });
//     }
